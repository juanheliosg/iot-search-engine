  ...
  "Guardian extractor actor" must  {
    ...
    "work if everything is correct" in {
      ...
      val expectedResult = Set(
        """{"measure":70.0,"city":"Santander","sampling_unit":"seconds","timestamp":"2021-03-23T12:04:00Z","measure_desc":"Vehículos por hora sobre una espiga","measureID":0,"country":"Spain","measure_name":"ocupation","long":"","sensorID":"1001","unit":"veh/h","seriesID":"101001","lat":"","name":"traffic-santander","sourceID":"1","description":"Santander traffic flow sensors","sampling_freq":1,"tags":["traffic","static"],"region":"Santander","address":""}"""
        ,"""{"measure":360.0,"city":"Santander","sampling_unit":"seconds","timestamp":"2021-03-23T12:04:00Z","measure_desc":"","measureID":1,"country":"Spain","measure_name":"intensity","long":"","sensorID":"1001","unit":"%","seriesID":"111001","lat":"","name":"traffic-santander","sourceID":"1","description":"Santander traffic flow sensors","sampling_freq":1,"tags":["traffic","static"],"region":"Santander","address":""}""",
        """{"measure":2.0,"city":"Santander","sampling_unit":"seconds","timestamp":"2021-03-23T12:04:00Z","measure_desc":"Vehículos por hora sobre una espiga","measureID":0,"country":"Spain","measure_name":"ocupation","long":"","sensorID":"1002","unit":"veh/h","seriesID":"101002","lat":"","name":"traffic-santander","sourceID":"1","description":"Santander traffic flow sensors","sampling_freq":1,"tags":["traffic","static"],"region":"Santander","address":""}""",
        """{"measure":120.0,"city":"Santander","sampling_unit":"seconds","timestamp":"2021-03-23T12:04:00Z","measure_desc":"","measureID":1,"country":"Spain","measure_name":"intensity","long":"","sensorID":"1002","unit":"%","seriesID":"111002","lat":"","name":"traffic-santander","sourceID":"1","description":"Santander traffic flow sensors","sampling_freq":1,"tags":["traffic","static"],"region":"Santander","address":""}"""
         )
